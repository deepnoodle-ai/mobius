...
export type SessionEventListResponse = components["schemas"]["SessionEventListResponse"];
export type SessionEventPayload = components["schemas"]["SessionEventPayload"];
export type SessionLifecycleFrame = components["schemas"]["SessionLifecycleFrame"];
