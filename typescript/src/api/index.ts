...
export type CreateOrgInviteRequest = components["schemas"]["CreateOrgInviteRequest"];
...
export type OrgInviteListResponse = components["schemas"]["OrgInviteListResponse"];
