...
export type AgentInvocation = components["schemas"]["AgentInvocation"];
...
export type CreateDataTableRequest = components["schemas"]["CreateDataTableRequest"];
...
export type DataTableListResponse = components["schemas"]["DataTableListResponse"];
export type DataTableRow = components["schemas"]["DataTableRow"];
export type DataTableRowSourceConfig = components["schemas"]["DataTableRowSourceConfig"];
export type DataTableSchema = components["schemas"]["DataTableSchema"];
...
export type UpdateDataTableRequest = components["schemas"]["UpdateDataTableRequest"];
