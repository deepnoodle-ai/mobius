...
func registerServiceAccountsCommands(app *cli.App) {
	serviceAccountsGrp := app.Group("service-accounts")
	serviceAccountsGrp.Alias("service-account")
	serviceAccountsGrp.Command("create-account").
	...
	serviceAccountsGrp.Command("delete-account").
	...
	serviceAccountsGrp.Command("get-account").
	...
	serviceAccountsGrp.Command("list-accounts").
	...
	serviceAccountsGrp.Command("update-account").
