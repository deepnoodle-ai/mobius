...
func registerRolesCommands(app *cli.App) {
	rolesGrp := app.Group("roles").Description("Project roles and role assignments")
	rolesGrp.Alias("role")
	rolesGrp.Command("create").
		...
		Flags(
			...
			cli.Strings("permissions", "").Help("[required] Permission strings to include. Source allowed values from `GET /v1/projects/{project}/permissions`;…"),
		...
		Run(func(ctx *cli.Context) error {
			...
			if ctx.IsSet("permissions") {
				body.Permissions = ctx.Strings("permissions")
			}
